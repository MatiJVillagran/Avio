...
import { cleanSearchProducts, renderCondition, searchProduct } from "../../../redux/actions/actions";
  ...
  return (
    <div className="w-full max-w-md mx-auto mb-4">
      ...
      <button
        ...
        type="submit"
        className="mt-2 w-full bg-tertiary text-white p-2 rounded-md hover:bg-gray-700"
      >
        Buscar
      </button>
    </div>
